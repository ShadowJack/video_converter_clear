...
foreach( $videos as $row ) 
{
    ...
    {
        echo "<a href='/video_converter/videos/".$row['id']."/flv'>flv</a></td><td>";
    }
    else
    {
        echo "mp4</td><td>";
    ...
    {
        echo "<a href='/video_converter/videos/".$row['id']."/mp4'>mp4</a></td><td>";
    }
    else
    {
        echo "mp4</td><td>";
    }
    echo "<a href='/video_converter/videos/".$row['id']."/meta'>info</a></td><td>".
